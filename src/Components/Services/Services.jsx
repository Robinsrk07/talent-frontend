...
console.log(serviceForm);
  ...
  const handleServiceSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(`Failed to ${isEditingService ? 'update' : 'create'} service`);
  ...
  const handleFeatureSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(`Failed to ${isEditingFeature ? 'update' : 'create'} feature`);
      console.error('Error:', error);
    }
  };
      ...
      {features.map((feature) => (
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 justify-between">
            {/* Feature title with bullet - now allows wrapping */}
            ...
            {/* Edit/Delete buttons - now stays properly aligned */}
